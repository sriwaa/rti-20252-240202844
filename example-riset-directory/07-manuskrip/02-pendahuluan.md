...
## 2. Latar Belakang, Rumusan Masalah, dan Pertanyaan Penelitian

### 2.1 Latar Belakang

Perkembangan teknologi finansial di Indonesia telah membawa perubahan besar pada cara masyarakat melakukan transaksi harian, khususnya melalui penggunaan dompet digital yang semakin masif. Transformasi ini melahirkan dua model arsitektur aplikasi yang berbeda di pasar: model Super App yang mengintegrasikan berbagai layanan dalam satu pintu, dan model Stand-alone App yang fokus pada efisiensi fungsi tunggal. Di lingkungan akademis seperti Universitas Putra Bangsa (UPB) Kebumen, mahasiswa sebagai kelompok pengguna tech-savvy sangat bergantung pada kecepatan dan kemudahan akses fitur finansial untuk mendukung mobilitas mereka yang tinggi.

Namun, strategi pengembangan aplikasi model Super App yang menyediakan berbagai layanan kompleks mulai dari pembayaran, transportasi, hiburan, hingga investasi dalam satu antarmuka berpotensi menimbulkan masalah baru. Seiring bertambahnya fitur, kompleksitas elemen visual turut meningkat secara signifikan pada halaman utama aplikasi. Gejala nyata yang terukur di lapangan menunjukkan bahwa banyak pengguna sering terdiam sejenak (scanning delay) dan membutuhkan waktu yang lebih lama hanya untuk menemukan fitur utama. Akar masalah dari fenomena ini adalah adanya information overload atau beban informasi akibat kepadatan elemen visual dan arsitektur informasi yang rumit, yang secara langsung meningkatkan beban kognitif pengguna.

### 2.2 Rumusan Masalah dan Pertanyaan Penelitian (Research Question)

Dampak dari kompleksitas antarmuka pada Super App adalah terhambatnya efisiensi interaksi pengguna, terutama pada aktivitas finansial harian yang membutuhkan respons cepat seperti transaksi pemindaian QRIS. Masalah ini menjadi sangat relevan dalam konteks mahasiswa Universitas Putra Bangsa Kebumen yang mengharapkan proses transaksi bersifat instan untuk mendukung produktivitas harian mereka.

Munculnya model aplikasi Stand-alone seperti GoPay yang memisahkan fitur finansial inti dari layanan eksternal lainnya menawarkan potensi efisiensi waktu yang lebih tinggi. Namun, perbedaan performa teknis durasi nyata dari kedua model arsitektur tersebut belum pernah diuji secara empiris menggunakan data kuantitatif objektif di lingkungan kampus.

*   **Rumusan Masalah (Problem Statement):**
    Mahasiswa Universitas Putra Bangsa Kebumen selaku pengguna dompet digital mengalami penurunan efisiensi waktu transaksi akibat beban kognitif dari kepadatan elemen visual pada antarmuka Super App (DANA), yang berdampak pada terhambatnya produktivitas dalam melakukan aktivitas finansial harian yang membutuhkan respons cepat.
*   **Pertanyaan Penelitian (Research Question / RQ):**
    "Apakah terdapat perbedaan signifikan pada rata-rata durasi waktu transaksi (Time-on-Task) antara aplikasi GoPay (model stand-alone) dan aplikasi DANA (model super app) pada mahasiswa Universitas Putra Bangsa?"

### 2.3 Tujuan Penelitian

Berdasarkan pertanyaan penelitian yang diajukan, tujuan utama dari penelitian ini adalah:

1. Menguji dan membuktikan secara empiris perbedaan tingkat efisiensi interaksi pengguna antara model arsitektur aplikasi Stand-alone (GoPay) dan Super App (DANA) berdasarkan performa durasi waktu nyata.
2. Memvalidasi hipotesis bahwa struktur antarmuka yang lebih sederhana pada aplikasi Stand-alone mampu memangkas waktu pengerjaan tugas transaksi secara signifikan dibandingkan model Super App.
...
- **Aplikasi DANA** di lingkungan kampus terkadang mengalami fluktuasi loading iklan promo—hal ini dicatat sebagai documentation resmi pemicu tingginya standar deviasi (0,84165) dibandingkan GoPay.
